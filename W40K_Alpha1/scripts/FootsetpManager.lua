...
function on_ready()
    ...
    local footstep_two_entity = current_scene:get_entity_by_name("PlayerStep2")
    footstep_two = footstep_two_entity:get_component("AudioSourceComponent")

    local footstep_three_entity = current_scene:get_entity_by_name("PlayerStep3")
