...
function on_ready()
    local shotgun_shot_entity = current_scene:get_entity_by_name("EscopetaDisparoAudio")
    shotgun_shot = shotgun_shot_entity:get_component("AudioSourceComponent")

    local shotgun_reload_entity = current_scene:get_entity_by_name("EscopetaRecargaAudio")
    shotgun_reload = shotgun_reload_entity:get_component("AudioSourceComponent")

    local grenade_launch_entity = current_scene:get_entity_by_name("GranadeLaunchAudio")
...
function playLaunchGranade()
    grenade_launch:pause()
    grenade_launch:play()  
end

function playExplodeGranade()
    grenade_explosion:pause()
    grenade_explosion:play()  
end
