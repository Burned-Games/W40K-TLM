...
function on_ready()
    ...
    for _, entity in ipairs(entities) do 
        ...
        if tag == "EnemyRange" or tag == "EnemySupport" or tag == "EnemyKamikaze" or tag == "EnemyTank" or tag== "EnemyTutorial" or tag== "EnemyRange2" or tag== "EnemyRange3" or tag== "EnemyRange4" or tag== "EnemyRange5" or tag== "EnemyRange6" or tag == "EnemyTank1" or tag == "EnemyTank2"
         or tag == "EnemyTank3" or tag == "EnemyTank4" or tag == "EnemyTank5" or tag == "EnemyTank6" or tag == "BarrilDestruible" or tag == "CajaDestruible" or tag == "CajaDestruibleV2" or tag == "ScrapPile" or tag == "MainBoss" then 
