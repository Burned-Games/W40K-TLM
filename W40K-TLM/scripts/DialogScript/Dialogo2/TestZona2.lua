dialogLines = {
    { name = "Radio2", text = "Soldier? Are you alive? If so, you're on a very important mission." },
    { name = "Radio2", text = "Do you see those orkz? They colonized this planet, go finish this two." }
}
