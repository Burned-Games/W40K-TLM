dialogLines = {
    { name = "Radio3", text = "Soldier? Are you alive? If so, you're on a very important mission." },
    { name = "Radio3", text = "Do you see those orkz? They colonized this planet, go finish this two." }
}
...
function on_ready()
   ...
   popupScriptComponent = current_scene:get_entity_by_name("PopUpManager"):get_component("ScriptComponent")
    ...
    if nameA == "Player" or nameB == "Player" then
        ...
        popupScriptComponent.show_popup(false, "QUEST STARTING3")
