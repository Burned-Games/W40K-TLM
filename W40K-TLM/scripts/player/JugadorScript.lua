...
function on_ready()
   ...
   entities = current_scene:get_all_entities()
    ...
    shotgunUpper = current_scene:get_entity_by_name("Shotgun_upper_player")
    shotgunLower = current_scene:get_entity_by_name("Shotgun_lower_player")
...
function detect_enemy(rayHit)
    ...
    return rayHit and rayHit.hasHit and rayHit.hitEntity and rayHit.hitEntity:is_valid() and (rayHit.hitEntity:get_component("TagComponent").tag == "EnemyRange" or rayHit.hitEntity:get_component("TagComponent").tag == "EnemyTutorial" or rayHit.hitEntity:get_component("TagComponent").tag == "EnemyRange2" 
    ...
    or rayHit.hitEntity:get_component("TagComponent").tag == "EnemyTank6" or rayHit.hitEntity:get_component("TagComponent").tag == "EnemyKamikaze" or rayHit.hitEntity:get_component("TagComponent").tag == "EnemyBoss")
